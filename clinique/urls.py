...
urlpatterns = [
     ...
     path('statistiques/', views.statistiques_mensuelles, name='statistiques_mensuelles'),
     path('statistiques_par_statut/', views.statistiques_par_statut, name='statistiques_par_statut'),
     ...
     path('rapport_ventes/', views.rapport_ventes, name='rapport_ventes'),
